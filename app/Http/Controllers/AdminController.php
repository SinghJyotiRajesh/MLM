...
class AdminController extends Controller
{
   ...
   public function brand_delete($id)
   {
    ...
    $brand->delete();
    return redirect()->route('admin.brands')->with('status','Brand has been delated Sucessfully');
   }
   ...
   public function category_delete($id)
   {
    ...
    $category->delete();
    return redirect()->route('admin.categories')->with('status','Category has been delated Sucessfully');
   }
   ...
   public function slide_update(Request $request)
   {
      $request->validate([
        ...
        if($request->hasFile('image'))
        {
          ...
          {
            File::delete(public_path(public_path('uploads/slides').'/'.$slide->image));
          }
          $image = $request->file('image');
          $file_extension = $request->file('image')->extension();
          $file_name = Carbon::now()->timestamp.'.'.$file_extension;
